...
class Validator:
    ...
    def validate(self, uri):
        ...
        required_components = [
            component for component, required in self.required_components.items() if required
        ]
        validated_components = [
            component for component, required in self.validated_components.items() if required
        ]
...
def ensure_required_components_exist(uri, required_components):
    ...
    missing_components = sorted(
        component for component in required_components if getattr(uri, component) is None
    )
