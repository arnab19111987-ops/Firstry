...
def load_pem_x509_certificate(data: bytes, backend: typing.Any = None) -> x509.Certificate: ...
def load_der_x509_certificate(data: bytes, backend: typing.Any = None) -> x509.Certificate: ...
...
class PolicyBuilder:
    ...
    def build_server_verifier(self, subject: x509.verification.Subject) -> ServerVerifier: ...
...
class ExtensionPolicy:
    ...
    def require_not_present(self, extension_type: type[x509.ExtensionType]) -> ExtensionPolicy: ...
    def may_be_present(
        self,
