...
class HTMLTranslator(writers._html_base.HTMLTranslator):
    ...
    def visit_citation(self, node) -> None:
        self.body.append(
            self.starttag(node, "table", CLASS="docutils citation", frame="void", rules="none")
        )
        self.body.append(
    ...
    def visit_citation_reference(self, node) -> None:
        ...
        self.body.append(
            self.starttag(node, "a", suffix="[", href=href, classes=["citation-reference"])
        )
        ...
        if self.compact_field_list:
            for field in node:
                ...
                if not (
                    ...
                    break
        self.body.append(
            self.starttag(node, "table", frame="void", rules="none", CLASS="docutils field-list")
        )
        self.body.append(
    ...
    def visit_footnote(self, node) -> None:
        self.body.append(
            self.starttag(node, "table", CLASS="docutils footnote", frame="void", rules="none")
        )
        self.body.append(
            '<colgroup><col class="label" /><col /></colgroup>\n' '<tbody valign="top">\n' "<tr>"
        )
    ...
    def visit_option_list(self, node) -> None:
        self.body.append(
            self.starttag(node, "table", CLASS="docutils option-list", frame="void", rules="none")
        )
        self.body.append(
    ...
    def should_be_compact_paragraph(self, node) -> bool:
        ...
        for child in node.parent.children[first:]:
            ...
            return False
        parent_length = len(
            [n for n in node.parent if not isinstance(n, (nodes.Invisible, nodes.label))]
        )
    ...
    def visit_term(self, node) -> None:
        self.body.append(
            self.starttag(node, "dt", "", classes=node.parent["classes"], ids=node.parent["ids"])
        )
