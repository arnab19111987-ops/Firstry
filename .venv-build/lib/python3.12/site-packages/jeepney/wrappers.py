...
class MessageGenerator:
    ...
    def __repr__(self):
        return "{}({!r}, bus_name={!r})".format(
            type(self).__name__, self.object_path, self.bus_name
        )
...
class Properties:
    ...
    def set(self, name, signature, value):
        ...
        return new_method_call(
            self.props_if, "Set", "ssv", (self.obj.interface, name, (signature, value))
        )
