...
"""
from .low_level import HeaderFields, Message, MessageType
...
class DBus(MessageGenerator):
    ...
    def __init__(
        self, object_path="/org/freedesktop/DBus", bus_name="org.freedesktop.DBus"
    ):
    ...
    def GetConnectionSELinuxSecurityContext(self, name):
        return new_method_call(
            self, "GetConnectionSELinuxSecurityContext", "s", (name,)
        )
