...
class URLLib3Session:
    ...
    def __init__(
        ...
        self._verify = verify
        self._proxy_config = ProxyConfiguration(proxies=proxies, proxies_settings=proxies_config)
    ...
    def _proxies_kwargs(self, **kwargs):
        ...
        proxies_kwargs = {
            "use_forwarding_for_https": proxies_settings.get("proxy_use_forwarding_for_https"),
            **kwargs,
        }
    ...
    def _get_request_target(self, url, proxy_url):
        ...
        using_https_forwarding_proxy = proxy_scheme == "https" and self._proxies_kwargs().get(
    ...
    def send(self, request):
        try:
            ...
            if ensure_boolean(os.environ.get("BOTO_EXPERIMENTAL__ADD_PROXY_HOST_HEADER", "")):
            ...
            raise ConnectionClosedError(error=e, request=request, endpoint_url=request.url)
