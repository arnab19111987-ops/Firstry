...
def resolve_request_checksum_algorithm(
    ...
    request_checksum_calculation = request["context"]["client_config"].request_checksum_calculation
    http_checksum = operation_model.http_checksum
    request_checksum_required = operation_model.http_checksum_required or http_checksum.get(
    ...
    if operation_model.has_streaming_input and urlparse(request["url"]).scheme == "https":
...
def apply_request_checksum(request):
    ...
    if "request_algorithm_header" in checksum_context:
        ...
        request["headers"][request_algorithm_header["name"]] = request_algorithm_header["value"]
...
def _register_checksum_algorithm_feature_id(algorithm):
    ...
    checksum_algorithm_name_feature_id = f"FLEXIBLE_CHECKSUMS_REQ_{checksum_algorithm_name}"
