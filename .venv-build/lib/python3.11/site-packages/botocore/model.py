...
class OperationModel:
    ...
    def idempotent_members(self):
        ...
        return [
            ...
            if "idempotencyToken" in shape.metadata and shape.metadata["idempotencyToken"]
        ]
    ...
    def context_parameters(self):
        ...
        return [
            ...
            if "contextParam" in shape.metadata and "name" in shape.metadata["contextParam"]
        ]
...
class UnresolvableShapeMap:
    ...
    def resolve_shape_ref(self, shape_ref):
        raise ValueError(
            f"Attempted to resolve shape '{shape_ref}', but no shape " f"map was provided."
        )
