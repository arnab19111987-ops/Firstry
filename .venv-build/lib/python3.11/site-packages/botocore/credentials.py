...
def create_credential_resolver(session, cache=None, region_name=None):
    ...
    imds_config = {
        ...
        "ec2_metadata_v1_disabled": session.get_config_variable("ec2_metadata_v1_disabled"),
    }
...
class Credentials:
    ...
    def get_frozen_credentials(self):
        return ReadOnlyCredentials(self.access_key, self.secret_key, self.token, self.account_id)
...
class RefreshableCredentials(Credentials):
    ...
    def __init__(
        ...
        self.method = method
        self._frozen_credentials = ReadOnlyCredentials(access_key, secret_key, token, account_id)
        self._normalize()
...
class AssumeRoleProvider(CredentialProvider):
    ...
    def _resolve_credentials_from_profile(self, profile_name):
        ...
        elif self._has_static_credentials(profile) or not self._has_assume_role_config_vars(
            profile
        ):
    ...
    def _resolve_credentials_from_source(self, credential_source, profile_name):
        ...
        named_provider_feature_id = self.NAMED_PROVIDER_FEATURE_MAP.get(credential_source)
