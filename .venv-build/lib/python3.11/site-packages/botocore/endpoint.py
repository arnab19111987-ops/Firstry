...
class Endpoint:
    ...
    def _send_request(self, request_dict, operation_model):
        ...
        success_response, exception = self._get_response(request, operation_model, context)
    ...
    def _get_response(self, request, operation_model, context):
        ...
        success_response, exception = self._do_get_response(request, operation_model, context)
        kwargs_to_emit = {
            "response_dict": None,
...
class EndpointCreator:
    ...
    def create_endpoint(
        ...
        if not is_valid_endpoint_url(endpoint_url) and not is_valid_ipv6_endpoint_url(endpoint_url):
