...
class ParseError(JMESPathError):
    ...
    def __str__(self):
        ...
        return "%s: Parse error at column %s, " 'token "%s" (%s), for expression:\n"%s"\n%s' % (
            self.msg,
            self.lex_position,
            self.token_value,
            self.token_type,
...
class LexerError(ParseError):
    ...
    def __str__(self):
        ...
        return "Bad jmespath expression: %s:\n%s\n%s" % (self.message, self.expression, underline)
...
class JMESPathTypeError(JMESPathError):
    ...
    def __str__(self):
        return (
            ...
            % (self.function_name, self.current_value, self.expected_types, self.actual_type)
        )
