...
def validate(
    ...
    *,
    ...
    for index, token in enumerate(expected_tokens_unprocessed[1:], start=1):
        ...
        if index + 1 < len(expected_tokens_unprocessed):
            ...
            if (
                ...
                or (current_token.type == "FSTRING_MIDDLE" and next_token.type == "FSTRING_END")
    ...
    our_tokens = (
        ...
        for token in pytokens.tokenize(source_string, issue_128233_handling=issue_128233_handling)
