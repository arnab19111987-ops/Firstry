...
from ._run_cmd import CompletedProcess, require_command as _require_command, run as _run
...
class HgWorkdir(Workdir):
    ...
    def _get_node_date(self, dirty: bool, node_date_str: str, dirty_date: str) -> datetime.date:
    ...
    def _get_version_from_tags(self, tags: list[str], config: Configuration) -> Version | None:
    ...
    def hg_log(self, revset: str, template: str) -> str:
        return run_hg(["log", "-r", revset, "-T", template], cwd=self.path, check=True).stdout
