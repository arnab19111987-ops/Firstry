...
def strip_path_suffix(full_path: str, suffix_path: str, error_msg: str | None = None) -> str:
    ...
    if error_msg:
        ...
        assert normalized_full.endswith(
            suffix_path
...
def assert_path_endswith(full_path: str, suffix_path: str, error_msg: str | None = None) -> None:
