...
from . import _config, _entrypoints, _run_cmd, _types as _t
from ._config import Configuration
from ._overrides import _read_pretended_version_for
from ._version_cls import _validate_version_cls
from .version import ScmVersion, format_version as _format_version
...
def write_version_files(config: Configuration, version: str, scm_version: ScmVersion) -> None:
...
def _get_version(
    ...
    if force_write_version_files is None:
        ...
        warnings.warn(
            "force_write_version_files ought to be set," " presuming the legacy True value",
            DeprecationWarning,
        )
...
def _version_missing(config: Configuration) -> NoReturn:
    base_error = f"setuptools-scm was unable to detect version for {config.absolute_root}.\n\n"
    ...
    if scm_parent is not None:
        ...
        error_msg = (
            base_error + f"However, a repository was found in a parent directory: {scm_parent}\n\n"
        ...
        error_msg = (
            base_error + "Make sure you're either building from a fully intact git repository "
