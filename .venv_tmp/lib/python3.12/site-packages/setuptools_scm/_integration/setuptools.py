...
from .pyproject_reading import PyProjectData, read_pyproject
from .setup_cfg import SetuptoolsBasicData, extract_from_legacy
...
def version_keyword(
    ...
    *,
    ...
    assert "dist_name" not in overrides, "dist_name may not be specified in the setup keyword "
