...
class Iso8601Date(BaseHelper):
    ...
    def deserialize(cls, o: Any) -> date:
        try:
            ...
            raise ValueError(
                f'Date string supplied ({o}) does not match either "{Iso8601Date._PATTERN_DATE}"'
            )
    ...
    def deserialize(cls, o: Any) -> datetime:
        try:
            ...
            if v.endswith("Z"):
                ...
                v = f"{v[:-1]}+00:00"
            return datetime.fromisoformat(cls.__fix_microseconds(v))
        except ValueError:
