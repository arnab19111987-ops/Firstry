...
class CreId(serializable.helpers.BaseHelper):
    ...
    def __init__(self, id: str) -> None:
        if CreId._VALID_CRE_REGEX.match(id) is None:
            raise InvalidCreIdException(f'Supplied value "{id} does not meet format specification.')
        self._id = id
    ...
    def serialize(cls, o: Any) -> str:
        if isinstance(o, cls):
            return str(o)
        raise SerializationOfUnexpectedValueException(f"Attempt to serialize a non-CreId: {o!r}")
...
class Requirement:
    ...
    def __comparable_tuple(self) -> _ComparableTuple:
        ...
        return _ComparableTuple(
            (
                ...
                _ComparableTuple(self.open_cre),
                self.parent,
    ...
    def __repr__(self) -> str:
        return (
            f"<Requirement bom-ref={self._bom_ref}, identifier={self.identifier}, "
...
class Level:
    ...
    def requirements(self, requirements: Iterable[Union[str, BomRef]]) -> None:
        self._requirements = SortedSet(
            map(_bom_ref_from_str, requirements)  # type: ignore[arg-type]
        )
    ...
    def __repr__(self) -> str:
        return (
            f"<Level bom-ref={self.bom_ref}, identifier={self.identifier}, "
...
class Standard:
    ...
    def __repr__(self) -> str:
        return (
            f"<Standard bom-ref={self.bom_ref}, "
...
class Definitions:
    ...
    def __init__(self, *, standards: Optional[Iterable[Standard]] = None) -> None:
