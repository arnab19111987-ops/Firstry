        ...
        *,
        ...
        try:
            return self.make_with_id(
                value, text=license_text, url=license_url, acknowledgement=license_acknowledgement
            )
        except InvalidSpdxLicenseException:
            pass
        try:
            return self.make_with_expression(value, acknowledgement=license_acknowledgement)
        except InvalidLicenseExpressionException:
            pass
        return self.make_with_name(
            value, text=license_text, url=license_url, acknowledgement=license_acknowledgement
        )

    def make_with_expression(
        self, expression: str, *, acknowledgement: Optional["LicenseAcknowledgement"] = None
    ) -> LicenseExpression:
    ...
    def make_with_id(
        ...
        *,
        ...
        return DisjunctiveLicense(
            id=spdx_license_id, text=text, url=url, acknowledgement=acknowledgement
        )
