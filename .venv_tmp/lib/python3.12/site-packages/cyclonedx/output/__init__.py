...
class BaseOutput(ABC):
    ...
    @property
    @abstractmethod
    def schema_version(self) -> SchemaVersion: ...  # pragma: no cover

    @property
    @abstractmethod
    def output_format(self) -> OutputFormat: ...  # pragma: no cover
    ...
    @abstractmethod
    def generate(self, force_regeneration: bool = False) -> None: ...  # pragma: no cover

    @abstractmethod
    def output_as_string(
        self, *, indent: Optional[Union[int, str]] = None, **kwargs: Any
    ) -> str: ...  # pragma: no cover
...
@overload
def make_outputter(
    bom: "Bom", output_format: Literal[OutputFormat.JSON], schema_version: SchemaVersion
) -> "JsonOutputter": ...  # pragma: no cover


@overload
def make_outputter(
    bom: "Bom", output_format: Literal[OutputFormat.XML], schema_version: SchemaVersion
) -> "XmlOutputter": ...  # pragma: no cover


@overload
def make_outputter(
    bom: "Bom", output_format: OutputFormat, schema_version: SchemaVersion
