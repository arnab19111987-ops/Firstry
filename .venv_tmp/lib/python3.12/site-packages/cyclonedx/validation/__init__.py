...
@overload
def make_schemabased_validator(
    output_format: Literal[OutputFormat.JSON], schema_version: "SchemaVersion"
) -> "JsonValidator": ...  # pragma: no cover


@overload
def make_schemabased_validator(
    output_format: Literal[OutputFormat.XML], schema_version: "SchemaVersion"
) -> "XmlValidator": ...  # pragma: no cover


@overload
def make_schemabased_validator(
    output_format: OutputFormat, schema_version: "SchemaVersion"
