...
def input_stats_match(cached: List[InputFileMeta], current: List[InputFileMeta]) -> bool:
    """
...
def get_cache_state(cache_entry: Optional[ToolCacheEntry], 
                   input_paths: List[str], 
                   policy_rerun_failures: bool = True) -> tuple[str, bool]:
    """
