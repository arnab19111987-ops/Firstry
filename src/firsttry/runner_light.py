...
class GateResult:
    def __init__(self, gate_id: str, ok: bool, skipped: bool = False, reason: str = "", watched_files: List[str] | None = None):
...
class LegacyRunner:
    ...
    def run_profile(self, root: Path, profile_name: str = "fast", since_ref: str | None = None) -> int:
        """Simplified runner that returns success."""
        return 0


# Backward compatibility functions
def run_profile(root: Path, profile_name: str = "fast", since_ref: str | None = None) -> int:
