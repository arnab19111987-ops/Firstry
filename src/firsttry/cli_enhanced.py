...
def handle_doctor(args: argparse.Namespace) -> int:
    ...
    try:
        from firsttry.doctor import run_doctor_report, render_human
        ...
        # Display the doctor report using the built-in renderer
        ...
        print("")
        print(f"📊 {total_count - failed_count}/{total_count} checks passed")
        ...
        print("❌ Doctor functionality not available in this build.")
        return 2
    except Exception as e:
